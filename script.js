...
(() => {
  ...
  const dict = {
    en: {
      ...
      inspirationNum: "№ 03.5 — Material Inspiration",
      inspirationLead: "The aesthetic standards we build to. References, not projects.",
      metric1Unit: "yrs",
      metric2Unit: "m²",
    ...
    "zh-hant": {
      ...
      inspirationNum: "№ 03.5 — 美學參考",
      inspirationLead: "我們追求的金屬外立面美學標準。為參考，非實際工程。",
      metric1Unit: "年",
      metric2Unit: "㎡",
      metric3Unit: "法人",
      metric4Unit: "+",
    ...
    "zh-hans": {
      ...
      inspirationNum: "№ 03.5 — 美学参考",
      inspirationLead: "我们追求的金属外立面美学标准。为参考，非实际工程。",
      metric1Unit: "年",
      metric2Unit: "㎡",
      metric3Unit: "法人",
      metric4Unit: "+",
