...
(() => {
  ...
  const dict = {
    en: {
      ...
      adv3Title: "Rich Project Experience<span class=\"zh\">豐富的工程項目經驗</span>",
      ...
      adv4Title: "Standardised Smart Production Line<span class=\"zh\">標準化智能生產線</span>",
      ...
      adv5Title: "International Production Equipment<span class=\"zh\">國際先進生產設備</span>",
      ...
      adv6Title: "Quality Assurance<span class=\"zh\">卓越的產品品質保障</span>",
      ...
      groupArea: "Area",
      groupKicker: "№ 06.01 — Group Structure · 集團架構",
      groupLoc: "Location",
      groupMotto: "匠心筑梦 · 智造未来",
      groupMottoEn: "Craftsmanship builds dreams · Intelligence shapes the future",
      groupRole: "Role",
      groupTag1: "Flagship · Production · 旗艦廠",
      groupTag2: "Original Workshop · 创始工厂",
      groupTag3: "HK Sales · 香港销售",
      groupTag4: "HK Engineering · 香港工程",
      ...
      timeline1: "澤正金屬成立 — focused on precision metalworking",
      timeline2: "長磊五金成立 — production lines extended into supply chain",
      timeline3: "和廣幕牆成立 — entered curtain-wall & façade engineering",
      timeline4: "東排金屬製品 — 47,000 m² Huizhou flagship · one-stop hardware partner for large-scale HK projects",
